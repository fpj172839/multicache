...
import com.github.perry.multicache.config.CacheRedisCaffeineProperties;
...
public class RedisCaffeineCache extends AbstractValueAdaptingCache {
    ...
    private Object getKey(Object key) {
        String appendKey = StringUtils.isEmpty(cachePrefix) ? key.toString() : cachePrefix.concat(":").concat(key.toString());
        return this.name.concat(":").concat(appendKey);
    }
    ...
    private void push(CacheMessage message) {
        redisTemplate.convertAndSend(topic, JSONObject.toJSON(message));
    }
